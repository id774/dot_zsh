...
#  - This installer uses portable /bin/sh syntax and requires zsh to compile configuration files.
...
zsh_compile() {
    ...
    for file in "$SCRIPT_HOME/dot_zsh/lib/"*.zsh "$SCRIPT_HOME/dot_zsh/plugins/"*.zsh; do
...
uninstall() {
    ...
    [ "$UNINSTALL_FAILED" -eq 0 ] || return 1
